<aside class="neo-sidebar w-64 flex flex-col flex-shrink-0">
    ...
    <nav class="flex-1 py-6 px-4 space-y-1 overflow-y-auto">
        ...
        <a href="/admin/amenities" class="sidebar-link flex items-center space-x-4 py-3 px-4 text-graphite/50 hover:text-ink hover:bg-ink/[0.03] transition-all"><i class="fas fa-swimmer w-4 text-center text-sm"></i><span class="text-sm font-sans">Amenities</span></a>
        ...
        <a href="/admin/content" class="sidebar-link flex items-center space-x-4 py-3 px-4 text-graphite/50 hover:text-ink hover:bg-ink/[0.03] transition-all"><i class="fas fa-edit w-4 text-center text-sm"></i><span class="text-sm font-sans">Content</span></a>
