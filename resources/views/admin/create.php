...
<body class="antialiased min-h-screen">
    ...
    <div class="max-w-3xl mx-auto px-6 py-12">
        <a href="dashboard.php" class="text-[10px] font-body uppercase tracking-[0.25em] text-rust/60 hover:text-rust transition mb-8 inline-block">&larr; Back to Dashboard</a>
        ...
        <?php if($success): ?>
            <div class="bg-sand/10 border border-sand/20 text-sand/80 p-4 mb-6 text-sm font-body">Property created successfully! <a href="create.php" class="underline">Add another</a></div>
        <?php endif; ?>
        <?php if($message): ?>
