    ...
    <div class="flex h-screen overflow-hidden">
        <aside class="neo-sidebar w-64 flex flex-col flex-shrink-0">
            ...
            <nav class="flex-1 py-6 px-4 space-y-1 overflow-y-auto">
                ...
                <a href="inquiries.php" class="sidebar-link active flex items-center space-x-4 py-3 px-4 text-ink transition-all"><i class="fas fa-envelope w-4 text-center text-sm"></i><span class="text-sm font-medium font-sans">Inquiries</span></a>
